...
<body>
	<header class="main-header"> <!-- Logo --> <a
		...
		<span class="logo-mini">ERP</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>My</b>ERP</span>
				...
				<ul class="dropdown-menu">
					...
					<li class="user-footer">
						...
						<div class="pull-right">
							<a href="../MyERP/logout" class="btn btn-default btn-flat">Sign out</a>
						</div>
					</li>
				</ul></li>
